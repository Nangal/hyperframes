...
- **Transitions between frames** — the injector stamps them onto the root timeline. Author **entrance only** (an exit **only if you are the final frame**).
